...
#mkdir -p ../../../vendor/motorola/zeppelin/overlay/packages/apps/Launcher2/res/layout
#(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/motorola/zeppelin/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
